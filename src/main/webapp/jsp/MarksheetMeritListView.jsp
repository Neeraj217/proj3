...
<body>
    ...
    <br>
        <div class="container">
        <div class="row">
        <div class="panel" style="background-color:  rgba(248, 222, 210, 0.85); margin-bottom: 80px;" >
		...
		<div class="row">
			...
			<a style="font-size: 16px;" href="/proj3/ctl/JasperCtl" class="btn btn-primary" role="button" target = "blank">
