<%@page import="in.co.rays.proj3.ctl.MarksheetListCtl"%>
...
<!--    favicon-->
<link rel="shortcut icon" href="/proj3/theam_wel/image/fav-icon.png"
	type="image/x-i">
	...
	<br><br><br>
           ...
           <div class="form-inline" >
				<div class="form-group  text-center">
					...
					placeholder="Enter Student Name" value="<%=ServletUtility.getParameter("name", request)%>">
				</div>				&emsp;&emsp;
				
				<div class="form-group text-center">
					<label class="control-label" for="rollNo">Roll No. :</label>
					<input type="text" name="rollNo" class="form-control" 
					placeholder="Enter Roll No" size=15 value="<%=ServletUtility.getParameter("rollNo", request)%>">
				</div>
