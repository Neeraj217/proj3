...
<head>
 <!--    favicon-->
    <link rel="shortcut icon" href="/proj3/theam_wel/image/fav-icon.png" type="image/x-icon">
    
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<!-- for Jquery Calander  -->
<link rel="stylesheet" href="/proj3/css/jquery-ui.css">
<script src="/proj3/js/bootstrap.min.js"></script>
<script src="/proj3/js/jquery.min.js"></script>

<link rel="stylesheet" href="/proj3/js/bootstrap.min.css">

<link rel="stylesheet" href="/proj3/js/font-awesome.min.css">
...
<link rel="stylesheet" href="/proj3/css/jquery-ui.css">
<script src="/proj3/js/jquery.min.js"></script>
<script src="/proj3/js/jquery-1.12.4.js"></script>
<script src="/proj3/js/jquery-ui.js"></script>
...
<!-- <div class="video-wrap">
		...
		<source src="/proj3/stars.mp4"" type="video/mp4">
		</video></div> -->
	...
	<nav class="navbar navbar-inverse navbar-fixed-top" style="background-color: rgba(28, 35, 49, 0.6);">
		<div class="container-fluid">
			<ul class="nav navbar-nav navbar-left" style="background-color: #3030358f">
				<img src="/proj3/image/download.png" width="130" height="52" class="img-responsive">
			</ul>
			...
			<div class="collapse navbar-collapse"
        		...
        		style="font-size:18px;margin-right: 3px;"></span><%
 						...
 						%> Hello, <%=userdto.getFirstName()%>(<%=role%>)<span
								class="caret"></span> <%
 						}
 						%>
						</b></a>
