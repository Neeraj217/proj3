...
<!--    favicon-->
    <link rel="shortcut icon" href="/proj3/theam_wel/image/fav-icon.png" type="image/x-i">
...
<body>
    ...
    <br>
        <div class="container">
        <div class="row">
        <div class="panel" style="background-color:  rgba(248, 222, 210, 0.85); margin-bottom: 100px;" >
	...
	<br><br><br>
		...
		<div class="form-group  text-center col-md-offset-1">
				...
				<div class="center">	
				&emsp;
				<label class="control-label" style="margin-left: -100%; max-width: 100%;">Course Name :</label>
				...
				<div class="form-group  text-center col-md-offset-1">
				<div class="center">	
				<label class="control-label" style="margin-left: -40%; max-width: 100%;">Subject Name :</label>
